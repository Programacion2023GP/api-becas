...
class AnswerScoreController extends Controller
{
    ...
    public function createOrUpdate(Request $request, Response $response, Int $id = null)
    {
        ...
        try {
            ...
            $answer_score->services_1 = $request->services_1;
            $answer_score->services_2 = $request->services_2;
            $answer_score->services_3 = $request->services_3;
            $answer_score->services_4 = $request->services_4;
            $answer_score->services_5 = $request->services_5;
            $answer_score->services_6 = $request->services_6;
            $answer_score->services_7 = $request->services_7;
