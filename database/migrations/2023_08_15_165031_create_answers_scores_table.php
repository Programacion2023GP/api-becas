...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('answers_scores', function (Blueprint $table) {
            ...
            $table->integer('services_1')->comment("estructura: pts");
            $table->integer('services_2')->comment("estructura: pts");
            $table->integer('services_3')->comment("estructura: pts");
            $table->integer('services_4')->comment("estructura: pts");
            $table->integer('services_5')->comment("estructura: pts");
            $table->integer('services_6')->comment("estructura: pts");
            $table->integer('services_7')->comment("estructura: pts");
