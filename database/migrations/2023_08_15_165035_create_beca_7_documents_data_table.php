...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('beca_7_documents_data', function (Blueprint $table) {
            ...
            $table->string('b7_img_tutor_ine', 255);
            $table->boolean('b7_approved_tutor_ine');
            ...
            $table->string('b7_img_proof_address', 255);
            $table->boolean('b7_approved_proof_address');
            $table->string('b7_comments_proof_address', 250)->nullable()->default("Archivo cargado correctamente.");

            $table->string('b7_img_curp', 255);
            $table->boolean('b7_approved_curp');
            $table->string('b7_comments_curp', 250)->nullable()->default("Archivo cargado correctamente.");

            $table->string('b7_img_birth_certificate', 255);
            $table->boolean('b7_approved_birth_certificate');
            $table->string('b7_comments_birth_certificate', 250)->nullable()->default("Archivo cargado correctamente.");

            $table->string('b7_img_academic_transcript', 255)->comment("Constancia de estudios con calificación");
            $table->boolean('b7_approved_academic_transcript');
